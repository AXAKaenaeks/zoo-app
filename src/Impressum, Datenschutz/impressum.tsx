...
function Impressum() {
    return (
        <div>
            ...
            <p>Zoo-Tropolis<br/>Römerstrasse<br/>8400 Winterthur<br/>Schweiz<br/>info@zootropolis.com<br/>+41 78 123 63 59</p>
            <h2>Vertretungsberechtigte Personen</h2>
            <p>Loris Frei, Founder<br/>Luca Reinle, Founder<br/>Nick Werginz, Founder<br/>Eleni Müller, Founder</p>
            ...
            <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf der Website gehören
                ausschliesslich der Firma Zoo-Tropolis oder den speziell genannten Rechtsinhabern. Für die Reproduktion jeglicher
                Elemente ist die schriftliche Zustimmung der Urheberrechtsträger im Voraus einzuholen.</p>
            <h2>Quelle</h2>
            <p>Dieses Impressum wurde am 3.04.2023 mit dem Impressum Generator der Webdesign Agentur <a href='https://webkoenig.ch/'
                                                                                                        target='_blank'>Webkönig</a>
                erstellt. Die Agentur Webkönig übernimmt keine Haftung.</p>
        </div>
    );
}
